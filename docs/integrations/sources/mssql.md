...
|:------------|:-----------|:------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.3.7       | 2026-04-21 | [76924](https://github.com/airbytehq/airbyte/pull/76924)                                                          | Fix `Invalid column name` error on system-versioned temporal tables by projecting explicit columns in the sampling subquery instead of `SELECT *`. |
